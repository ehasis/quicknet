---
name: csharp-mstest
description: 'Get best practices for MSTest 4.x unit testing, including modern assertion APIs and data-driven tests'
---

# MSTest Best Practices (MSTest 4.x)
...
- Reference MSTest 4.x NuGet packages (includes analyzers)
